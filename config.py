...
class Config:
    ...
    SITE_NAME = os.environ.get("SITE_NAME", "Best Fix Technical Services")
    SITE_DOMAIN = os.environ.get("SITE_DOMAIN", "bestfixit.ae")
    CONTACT_PHONE = os.environ.get("CONTACT_PHONE", "+971 54 739 3716")
    # WhatsApp number in international format, digits only (for wa.me links).
    WHATSAPP_NUMBER = os.environ.get("WHATSAPP_NUMBER", "971547393716")
    CONTACT_EMAIL = os.environ.get("CONTACT_EMAIL", "info@bestfixit.ae")
